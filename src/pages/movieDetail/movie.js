...
import { getMovieData } from "../../components/movieList/utils"
...
const Movie = () => {
    ...
    useEffect(() => {
        getMovieData(id).then(data => setMovie(data))
        window.scrollTo(0,0)
    }, [id])
                        ...
                        <>
                            {
                                ...
                                <span className="productionCompanyImage">
                                    <img className="movie__productionComapany" src={"https://image.tmdb.org/t/p/original" + company.logo_path} alt = "production company"/>
